...
enum PosPermission {
  ...
  exchangeRead('pos:exchange:read'),
  exchangeCreate('pos:exchange:create'),
  exchangeApprove('pos:exchange:approve'),
  exchangeRecover('pos:exchange:recover'),
  printPreview('pos:print:preview'),
  printReprint('pos:print:reprint'),
  orderCancel('pos:order:cancel'),
  orderDispose('pos:order:dispose'),
