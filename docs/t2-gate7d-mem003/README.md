# T2-MEM-003 独立正式开发文档索引

- [01_设计准入与验收冻结.md](01_设计准入与验收冻结.md)
- [02_Member_Owner独立验证记录.md](02_Member_Owner独立验证记录.md)
- [03_Pricing_Owner独立验证记录.md](03_Pricing_Owner独立验证记录.md)
...
当前仅 Order/Refund 阶段进入实现。仅授权内部软件实现和合成证据，不改变外部
