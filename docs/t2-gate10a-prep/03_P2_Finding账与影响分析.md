...
当前登记 10 项 P2，P0/P1 仍为 0。机器权威为 `contracts/t2/gate10a-prep/findings-register-v1.json`。

| Finding | 批次 | 风险 | 允许的关闭方式 |
|---|---|---|---|
| G10A-CI-P2-001 | R1 | Action Node 20/setup-java v4 生命周期 | Node24 兼容回归、精确 SHA、全门禁 |
| G10A-DEP-P2-001 | R1 | 四栈升级候选/兼容风险无同窗快照 | 分生态升级清单、漏洞/许可证/回退 |
| G10A-SUP-P2-001 | R1 | 76 工作流供应链步骤重复 | 单一版本账、活动/历史工作流治理 |
