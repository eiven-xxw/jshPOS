...
public class SaasPersistenceAdapter implements SaasPersistencePort {
    ...
    public SubscriptionAccessRecord findSubscriptionAccess(String t){return mapper.findSubscriptionAccess(t);} public void insertSubscriptionAccess(SubscriptionAccessWrite w){mapper.insertSubscriptionAccess(w);}
    public int changeSubscriptionAccess(SubscriptionAccessChange c){return mapper.changeSubscriptionAccess(c);} public void appendSubscriptionAccessEvent(SubscriptionAccessEventWrite w){mapper.appendSubscriptionAccessEvent(w);}
}
