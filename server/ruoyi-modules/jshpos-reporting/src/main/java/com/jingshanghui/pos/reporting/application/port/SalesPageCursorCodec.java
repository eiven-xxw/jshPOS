...
/** 销售报表游标签名端口；游标必须绑定可信租户、冻结筛选摘要和投影版本。 */
public interface SalesPageCursorCodec {
     ...
     */
    record CursorEnvelope(String tenantId, String filterSha256, String projectionVersion, SalesKey after) {
    }
}
