...
def main() -> int:
    ...
    index = {
        ...
        "classification": "INTERNAL_CI_DEPENDENCY_SUPPLY_CHAIN_VERIFIED_CANDIDATE",
        "producerCount": len(EXPECTED),
        "fileCount": len(files),
        "openP0": 0,
        "openP1": 0,
        "verifiedP2AwaitingSponsor": 3,
        "applicationDependencyChanges": 0,
    ...
    print(f"T2 Gate10A R1 evidence OK: producers={len(EXPECTED)} files={len(files)}")
    return 0
