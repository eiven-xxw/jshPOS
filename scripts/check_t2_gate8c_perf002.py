...
def validate_scope() -> list[str]:
    ...
    allowed_exact = {
        ...
        "docs/governance/CR-T2G8C-015_perf002-formal-runtime-permission-fixture-failure.md",
        "docs/governance/CR-T2G8C-016_perf002-security-scope-order-failure.md",
        "docs/governance/CR-T2G8C-017_perf002-evidence-producer-collision-failure.md",
        "docs/governance/CR-T2G8C-018_perf002-ci-conditional-pass.md",
