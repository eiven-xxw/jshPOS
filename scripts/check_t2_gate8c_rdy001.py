...
def validate_scope() -> list[str]:
    ...
    allowed_exact = {
        ...
        "docs/governance/CR-T2G8C-023_rdy001-third-candidate-tenant-metadata-allowlist-failure.md",
        "docs/governance/CR-T2G8C-024_rdy001-fourth-candidate-compose-secret-preflight-failure.md",
        "docs/governance/CR-T2G8C-025_rdy001-ci-conditional-pass.md",
