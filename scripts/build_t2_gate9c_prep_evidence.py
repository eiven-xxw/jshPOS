#!/usr/bin/env python3
"""聚合 Gate 9C-Prep 多平台制品并生成机器可读证据索引。"""
...
def main() -> int:
    ...
    index = {
        "schemaVersion": "1.0",
        "gate": "T2_GATE_9C_PREP",
        "commitSha": args.commit,
        "classification": "STATIC_GOVERNANCE_REPOSITORY_AND_BASELINE_REGRESSION",
    ...
    print(
        f"T2 Gate9C evidence OK: producers={len(EXPECTED_PRODUCERS)} files={len(files)}"
    )
    return 0
