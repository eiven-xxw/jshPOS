...
当前阶段：**T2 Gate 7B / Sprint S20-B 第二批准入准备**。第一批 `T2-POS-010/POS-011/ORD-004` 已由项目发起人接受；本阶段只允许 `T2-EXG-001` 独立 CR 与 `T2-EXG-001/PAY-004` 的领域、契约、迁移和验收设计，二者继续 `DRAFT`，不得开发正式运行时。支付沙箱、真实硬件、真实打印和设计伙伴继续 `BLOCKED`，完整 Alpha 与发布继续 `DRAFT`；不得宣称可试点、可生产或可商用。
